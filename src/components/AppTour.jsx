...
export default function AppTour({ onDone, theme, THEMES }) {
  ...
  const feats = [
    ...
    { ic: "◈", sec: "Профиль", color: "#9F7BD8", title: "Тест психологической энергии", desc: "7 вопросов — уровень ресурса с расшифровкой.", tip: "Проходите раз в 1–2 недели для отслеживания динамики" },
  ];
