...
export default function AppTour({ onDone, theme }) {
  ...
  const feats = [
    { ic: "🌕", sec: "Главная", color: "#D43878", title: "Выбирайте настроение", desc: "Нажмите на карточку — интерфейс подстроится под вас.", tip: "Настроение меняет цвет интерфейса и рекомендации" },
    { ic: "◦", sec: "Библиотека", color: "#D08040", title: "17 медитаций в 5 разделах", desc: "Каждая практика решает конкретный запрос.", tip: "Начните с бесплатной «Женское внутреннее расслабление» 19 мин" },
    { ic: "✦", sec: "Навигатор ситуаций", color: "#C88040", title: "Что меня беспокоит?", desc: "Выберите из 12 ситуаций — получите точные практики.", tip: "Можно выбрать несколько ситуаций сразу" },
    ...
    { ic: "◈", sec: "Профиль", color: "#5CB8C8", title: "Тест психологической энергии", desc: "7 вопросов — уровень ресурса с расшифровкой.", tip: "Проходите раз в 1–2 недели для отслеживания динамики" },
  ];
