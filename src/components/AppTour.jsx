...
export default function AppTour({ onDone, theme }) {
  ...
  const feats = [
    ...
    { ic: "◦", sec: "Библиотека", color: "#B84010", title: "17 медитаций в 5 разделах", desc: "Каждая практика решает конкрет��ый запрос.", tip: "Начните с бесплатной «Женское внутреннее расслабление» 19 мин" },
